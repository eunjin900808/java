...
public class SampleSum {
	...
	/*
	 * 매개 변수의 개수 및 종류(타입)의 차이를 두고
	 * 같은 이름의 메소드를 만드는 방법을 다형성(오버로딩)이라고 한다.
	 */
	public static void sum() {
		System.out.println(10+20);
	}
	public static void sum(int a, int b) { //매개변수 2개
		System.out.println(a+b);
	}
	public static void sum(String a, int b) { //타입이다른 매개변수 2개 형성가능
		System.out.println(a+b);
	}
	
//	public static void sum(int c, int b) { //사용불가
